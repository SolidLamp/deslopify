/*  Deslopify site-specific script: Warnings for AI websites on DuckDuckGo
...
if (domain.substring(0, 10) != "duckduckgo") {
    throw new Error("Not DuckDuckGo.");
}
...
(async (): Promise<void> => {
    await markAsAI("eVNpHGjtxRBq_gLOfGDr LQNqh2U1kzYxREs65IJu", 4);
})();
