/*  Deslopify site-specific script: Warnings for AI websites on Qwant
...
if (domain.substring(0, 5) != "qwant") {
    throw new Error("Not Qwant.");
}
...
(async (): Promise<void> => {
    ...
    const observer = new MutationObserver(() => {
        ...
        timeoutScript = setTimeout(async (): Promise<void> => {
            ...
            url = location.href;
            await markAsAI("external _8KhEw", 6);
        }, 500);
    });
    ...
    setTimeout(markAsAI, 1500, "external _8KhEw", 6);
})();
